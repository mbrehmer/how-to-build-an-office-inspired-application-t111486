...
namespace PersonalOrganizer.Common.DataModel
{
    ...
    public static class RepositoryExtensions
    {
        ...
        private static Expression<Func<TProjection, bool>> GetProjectionPrimaryKeyEqualsExpressionCore<TEntity, TProjection, TPrimaryKey>(IRepository<TEntity, TPrimaryKey> repository, TPrimaryKey key) where TEntity : class
        {
